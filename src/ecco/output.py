...
class OutputSeq:
    def __init__(self,
        ...
        Args:
            ...
            hidden_states: A list of with "laeyers + 1" elements. Each element
                has dimsions (batch, position, hidden_dimension) if huggingface transformers v4
                or (position, hidden_dimension) if v3
